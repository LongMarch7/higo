...
func setDefaults() {
	...
	viper.SetDefault("gk_service_path_format", path.Join("%s","%s"))
	viper.SetDefault("gk_cmd_service_path_format", path.Join("%s", "cmd", "service"))
	viper.SetDefault("gk_cmd_path_format", path.Join("%s", "cmd"))
	viper.SetDefault("gk_endpoint_path_format", path.Join("%s","%s"))
	viper.SetDefault("gk_http_path_format", path.Join("%s", "server"))
	viper.SetDefault("gk_http_client_path_format", path.Join("%s", "client"))
	viper.SetDefault("gk_grpc_client_path_format", path.Join("%s", "client"))
	viper.SetDefault("gk_client_cmd_path_format", path.Join("%s", "cmd", "client"))
	viper.SetDefault("gk_grpc_path_format", path.Join("%s","%s"))
	viper.SetDefault("gk_grpc_pb_path_format", path.Join("%s", "%s", "pb"))
