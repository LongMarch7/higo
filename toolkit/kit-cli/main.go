...
import (
	...
	"github.com/LongMarch7/higo/toolkit/kit-cli/cmd"
...
func setDefaults() {
	...
	viper.SetDefault("gk_service_path_format", path.Join("github.com", "LongMarch7", "higo","service","%s","%s"))
	viper.SetDefault("gk_cmd_service_path_format", path.Join("github.com", "LongMarch7", "higo","service","%s", "cmd", "service"))
	viper.SetDefault("gk_cmd_path_format", path.Join("github.com", "LongMarch7", "higo","service","%s", "cmd"))
	viper.SetDefault("gk_endpoint_path_format", path.Join("github.com", "LongMarch7", "higo","service","%s","%s"))
	viper.SetDefault("gk_http_path_format", path.Join("github.com", "LongMarch7", "higo","service","%s", "server"))
	viper.SetDefault("gk_http_client_path_format", path.Join("github.com", "LongMarch7", "higo","service","%s", "client"))
	viper.SetDefault("gk_grpc_client_path_format", path.Join("github.com", "LongMarch7", "higo","service","%s", "client"))
	viper.SetDefault("gk_client_cmd_path_format", path.Join("github.com", "LongMarch7", "higo","service","%s", "cmd", "client"))
	viper.SetDefault("gk_grpc_path_format", path.Join("github.com", "LongMarch7", "higo","service","%s","%s"))
	viper.SetDefault("gk_grpc_pb_path_format", path.Join("github.com", "LongMarch7", "higo","service","%s", "%s", "pb"))
	...
	viper.SetDefault("gk_grpc_base_file_name", "grpc_handler_gen.go")
	viper.SetDefault("gk_grpc_file_name", "grpc_handler.go")
	viper.SetDefault("gk_http_handler_file_name", "http_handler.go")
