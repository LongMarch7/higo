...
func main() {
    ...
    //set key-value
    mc.Set(&memcache.Item{Key: "237d1362ba6e1ceac40e13676309b798admin", Value: []byte("my value")})

    //get key's value

    it, _ := mc.Get("237d1362ba6e1ceac40e13676309b798admin")
    if string(it.Key) == "237d1362ba6e1ceac40e13676309b798admin" {
